...
# რისთვის ვიყენებთ: რომ მივწვდეთ სიაში რომელიმე კონკრეტულ ელემენტს, ამისათვის ვწერთ იმ სიის სახელს რომელი სიიდანაც მინდა რომ ამოვიღო
# ელემენტი.
...
#III დავალება: შექმენით სია სადაც შეიყვანთ ადამიანის სახელებს, უნდა გქონდეთ სულ 10 სახელი, თქვენი დავალებაა რომ გამოიტანოთ, მე-5, მე-9, მე-3,
#მე-7 და პირველ ინდექსზე მდგომი ელემენტები ცალ ცალკე, გამოიყენეთ ინდექსინგი.
...
#V დავალება: შექმენით სია სადაც შეინახავთ 7 ცალ ელემენტს (მონაცემის ტიპს არ აქვს მნიშვნელობა), თქვენი დავალებაა რომ ამ სიაში შეცვალოთ მე-3
#ინდექსზე მდგომი ელემენტი და ჩაანაცვლო "vashli"-ით, ასევე შეცვალე მე-6 ინდექსზე მდგომი ელემენტი და ჩაანაცვლე 'msxali'-ით, ასევე შეცვალე მე-4
#ინდექსზე მდგომი ელემენტი და ჩაანაცვლე ის 'atami"-ით, გამოიტანე საბოლოო სია ტერმინალში, სადაც ეს სალი ელემენტი იქნება განახლებული~
...
#XI დავალება: შექმენი სია რომელიც იქნება სტრინგებით სავსე, შენი დავალებაა რომ მომხმარებელს შემოატანინო რაიმე რიცხვი, შენი დავალებაა რომ ამ
#სიიდან გამოიტანო მომხმარებლის მიერ შემოტანილ რიცხვზე (ინდექსზე) მდგომი ელემენტი.
